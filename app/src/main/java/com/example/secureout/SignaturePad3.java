...
public class SignaturePad3 extends AppCompatActivity {
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (signatureBitmap != null) {
                    ...
                    try {
                        progressDialog = new ProgressDialog(SignaturePad3.this);
                        progressDialog.show();
    ...
    private File saveBitmapToFile(Bitmap bitmap) throws IOException {
        File file = new File(getCacheDir(), "signature3.jpg");
    ...
    private void uploadImage(File imageFile1) {
        if (imageFile1 == null) {
            Toast.makeText(SignaturePad3.this, "upload image is value NULL" , Toast.LENGTH_LONG).show();
            return;
        }
        ...
        Call<ResponseBody> call =retrofitAPI.uploadSig3(filePart1,docRequestBody);
        call.enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(SignaturePad3.this, "บึนทึกสำเร็จ" , Toast.LENGTH_LONG).show();
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(SignaturePad3.this, "API error: " + response.message(), Toast.LENGTH_LONG).show();
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(SignaturePad3.this, "Network error: " + t.getMessage(), Toast.LENGTH_LONG).show();
